...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype._css = '.treeview .list-group-item{cursor:pointer}.treeview span.indent{margin-left:1px;margin-right:1px}.treeview span.icon{width:12px;margin-right:1px}.treeview .node-disabled{color:silver;cursor:not-allowed}'
